  ...
  final Map<String, PageFactory> pagesMap = {
    AddUnitRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const AddUnitScreen(),
      );
    },
    ChooseUnitTypeRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const ChooseUnitTypeScreen(),
      );
    },
...
/// generated route for
/// [AddUnitScreen]
class AddUnitRoute extends PageRouteInfo<void> {
  const AddUnitRoute({List<PageRouteInfo>? children})
      : super(
          AddUnitRoute.name,
...
/// generated route for
/// [ChooseUnitTypeScreen]
class ChooseUnitTypeRoute extends PageRouteInfo<void> {
  const ChooseUnitTypeRoute({List<PageRouteInfo>? children})
      : super(
          ChooseUnitTypeRoute.name,
          initialChildren: children,
        );

  static const String name = 'ChooseUnitTypeRoute';
